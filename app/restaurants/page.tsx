        ...
        <div className="relative h-48 overflow-hidden bg-slate-100">
          ...
          >
            ...
            >
              <Heart
                size={14}
                className={isFavorite ? 'fill-[#E21B70] text-[#E21B70]' : 'text-slate-400'}
              />
            </motion.div>
          </motion.button>
        ...
        <div className="p-4">
          <div className="flex items-start justify-between gap-2 mb-3">
            ...
            {restaurant.deliveryFee === 0 && (
              <span className="shrink-0 text-[10px] font-bold text-green-600 bg-green-50 border border-green-200 rounded-full px-2 py-0.5">
                Free Delivery
              </span>
            )}
          </div>
          ...
          <div className="flex items-center gap-3 text-xs text-slate-400 font-medium">
            <span className="flex items-center gap-1">
              <Clock size={11} className="text-[#E21B70]" />
              {restaurant.deliveryTime} min
            </span>
            <span className="w-0.5 h-0.5 bg-slate-300 rounded-full" />
            <span className="flex items-center gap-1">
              <MapPin size={11} className="text-[#E21B70]" />
          ...
          <div className="mt-3 pt-3 border-t border-slate-50 flex items-center justify-between">
            <span className="text-[11px] text-slate-400">
              Min. <span className="font-semibold text-slate-600">${restaurant.minOrder}</span>
            </span>
            <motion.button
              whileHover={{ x: 2 }}
              className="text-[11px] font-bold text-[#E21B70] flex items-center gap-0.5"
            >
